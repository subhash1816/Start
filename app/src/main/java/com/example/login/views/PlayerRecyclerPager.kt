...
class PlayerRecyclerPager : Fragment() {
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.player_viewpager, container, false)
        val playerRecyclerView = view.findViewById<RecyclerView>(R.id.player_viewpager_recycler)
